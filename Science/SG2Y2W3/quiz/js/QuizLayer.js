	...
	var QuizLayer = QuizBaseLayer.extend({
		...
		onEnter: function () {
			...
			var mapConfig = {
				...
				audio: {
					bgm: resQuizAudio.bgm_mp3,
					pick: resQuizAudio.pick_mp3,
					box: resQuizAudio.pick_box_mp3,
					resolve: resQuizAudio.resolve_mp3
				},
				missions: [
					{
						type: 'point',
						...
						mission: {
							...
							question: {
								audio: resQuizAudio.question1_option1_mp3
							},
							options: [
								{
								...
								},
								{
									...
									position: [650, 300],
									audio: resQuizAudio.question1_option2_mp3,
									value: 0
								},
								{
									imgs: [resQuiz.question1_option3_png, resQuiz.question1_option3_png],
									position: [950, 300],
									audio: resQuizAudio.question1_option3_mp3,
									value: 0
								}
							]
						}
